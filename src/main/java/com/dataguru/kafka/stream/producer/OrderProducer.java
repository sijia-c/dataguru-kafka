package com.dataguru.kafka.stream.producer;
...
import com.dataguru.kafka.producer.HashPartitioner;
import com.dataguru.kafka.stream.model.Order;
import com.dataguru.kafka.stream.serdes.GenericSerializer;
...
public class OrderProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		props.put("bootstrap.servers", "9.186.96.128:9092");
		props.put("acks", "all");
		props.put("retries", 3);
